...
inputElement.addEventListener('change', (event) => {
    ...
    const linearDisplay = document.querySelector('#linear-display');
    const binaryDisplay = document.querySelector('#binary-display');

    const linearInput = linearSearch(dataset, event.target.value);
    const binaryInput = binarySearch(uniqueNums, event.target.value);
    
    linearDisplay.textContent = linearInput;
    binaryDisplay.textContent = binaryInput;
